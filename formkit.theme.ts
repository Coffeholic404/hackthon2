...
/**
  ...
  *
  * @checksum - 4887f2b25b12e355f4c34c73f25aa8a7dda829a9d4bffb388ff24f65053f0689
  * @variables - radius=rounded-lg,accentColor=violet,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
